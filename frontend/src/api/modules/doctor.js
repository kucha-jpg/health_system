...
export const removeDoctorGroupPatientApi = (id, patientUserId) => http.delete(`/doctor/groups/${id}/patients/${patientUserId}`)
...
export const removeDoctorGroupDoctorApi = (id, doctorUserId) => http.delete(`/doctor/groups/${id}/doctors/${doctorUserId}`)
