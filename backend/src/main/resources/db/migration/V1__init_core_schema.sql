...
INSERT IGNORE INTO sys_role (role_name, permission) VALUES
('ADMIN', 'admin:user:manage'),
('DOCTOR', 'doctor:home:view'),
('PATIENT', 'patient:home:view');

INSERT IGNORE INTO sys_user (username, password, phone, name, role_type, status)
VALUES ('admin', '$2a$10$9pQSWn/t60LoEORBgQYZ6uaIXc61bZeFEjbIMVWOVldUp27hzgfu6', '13800000000', '系统管理员', 'ADMIN', 1);
